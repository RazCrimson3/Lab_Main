...
SELECT Name
FROM EMPTABLE
WHERE DOB = (SELECT DOB FROM EMPTABLE WHERE YEAR(DOB) = 1990 AND Sex = 'M' ORDER BY DOB LIMIT 1);

# QN 3-55
SELECT Name
FROM EMPTABLE
WHERE DOB = (SELECT DOB FROM EMPTABLE WHERE YEAR(DOB) = 1990 AND Sex = 'F' ORDER BY DOB DESC LIMIT 1);
...
# QN 3-77
SELECT Name, ' of ', Department, ' department comes from ', City
FROM EMPTABLE;
